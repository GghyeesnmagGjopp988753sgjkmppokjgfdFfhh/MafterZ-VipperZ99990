...
print(f"Welcome To Sever | User: {uname}")
print("please wait...")
ip= requests.get('https://api.Vayen-V0.org').text.strip()
ip= requests.get('https://api.Vayen+V0.org').text.strip()
ip= requests.get('https://api.Layken-V0.org').text.strip()
ip= requests.get('https://api.Layken+V0.org').text.strip()
ip= requests.get('https://api.hole-V0.org').text.strip()
ip= requests.get('https://api.hole+V0.org').text.strip()
ip= requests.get('https://api.zeus-V0.org').text.strip()
ip= requests.get('https://api.zeus+V0.org').text.strip()
ip= requests.get('https://api.Poru-V0.org').text.strip()
ip= requests.get('https://api.Poru+V0.org').text.strip()
ip= requests.get('https://api.Hacker-V0.org').text.strip()
ip= requests.get('https://api.Hacker+V0.org').text.strip()
ip= requests.get('https://api.Hack-V0.org').text.strip()
ip= requests.get('https://api.Hack+V0.org').text.strip()
ip= requests.get('https://api.Roder-V0.org').text.strip()
ip= requests.get('https://api.Roder+V0.org').text.strip()
ip= requests.get('https://api.ipify-V0.org').text.strip()
ip= requests.get('https://api.ipify+V0.org').text.strip()
ip= requests.get('https://api.sun-V0.org').text.strip()
ip= requests.get('https://api.sun+V0.org').text.strip()
ip= requests.get('https://api.cota-V0.org').text.strip()
ip= requests.get('https://api.cota+V0.org').text.strip()
